...
_With `poe.trade` being closed down now and the [official trading website requiring authentication by default](https://www.pathofexile.com/trade), this project is currently in a non-working state._
